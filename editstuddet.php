<?php
    ...
    if(count($_GET)>0)
    {
        ...
        if(empty($admno)||empty($email))
        {
            if(empty($admno))
            {
                $message="<font color='red'>Admission number is empty.";
            }
            if(empty($email))
            {
                $message=$message. "<font color='red'>Email is empty.";
            }
        }
        else
        {
            ...
            {
                $message="<font color='red'>Email already exists!";
            }
            else if($count1==0 && $count2==1)
            {
                $message="<font color='red'>Admission number already exists!";
            }
            else if($count1==1 && $count2==1)
            {
                $message="<font color='red'>Student already added!";
            }
            else 
            {
                //inserting data to db
                $result = mysqli_query($mysqli, "INSERT INTO students (admno,email) VALUES ('$admno','$email')");
                $message="<font color='green'>Student Added Sucessfully!";
            }
        }
    }
?>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <hr>
            <a class="btn btn-primary" href="addstuddet.php">Add</a>
            <a class="btn btn-primary" href="editstuddet.php">Edit</a>
            <a class="btn btn-primary" href="deletestuddet.php">Delete</a>
